  ...
  <div  class="container">
    <form action="agregadoTicket.php" method="post">
        ...
        <div style="position: relative; justify-content: center; margin-left:30%; margin-right: 50%; margin-top: 100px;" class="col-md-3">
          <p><textarea class="col-sm-6" style="display: flex; justify-content: center; top: 100px; margin-top: 100px; width: 500px;" name="descripcion" placeholder="Descripción"></textarea></p>
        ...
        <div style="position: relative; justify-content: center; margin: 0px auto; align-items: center;" class="col-md-3">
         ...
         <input style="display: flex; margin: 0px auto; margin-left: 60%; margin-right: 60%;" type="submit" value="Enviar">      
      </form>
     </div>
